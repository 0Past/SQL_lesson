...
PLAYER_ANGLE_SPEED = 4 # Скорость поворота
ROCKET_SPEED = 3 # Скорость ракеты
COLISION_RADIUS = 22 # Радиус сферы коллизии
PLAYER_HP = 3 # Количество жизней
POW_CHANCE = 0.75 # 1 - Вероятность выпадения бонуса
ROCKET_LIFETIME = ROCKET_SPEED * 7 # Время жизни ракеты
MUSIC_VOLUME = 0.2 # Громкость музыки
ASTEROIDS_COUNT = 12 # Максимальное количество астероидов на игровом поле